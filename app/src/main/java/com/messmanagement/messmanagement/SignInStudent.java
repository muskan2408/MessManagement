...
public class SignInStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                progressDialog=new ProgressDialog(SignInStudent.this);
        ...
        createaccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(SignInStudent.this,SignUpStudent.class);
                startActivity(i);
            }
        });
    }
    ...
    private void startLogin(String emailid, String spassword) {
        ...
        Call<Model> call=retrofitInterface.login1(emailid,spassword);
...
//             Log.d("check",String.valueOf(model.getSuccess()));
                ...
                if(check){
                    progressDialog.cancel();
                    Toast.makeText(SignInStudent.this, "Signin Successful", Toast.LENGTH_SHORT).show();
                    // session.createLoginSession(mobile, pin,model.getToken());

                   token=model.getToken();

                    //  Log.e(TAG,token);
                    Intent i=new Intent(SignInStudent.this,Main2Activity.class);
...
//                    i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                ...
                {
                    Toast.makeText(SignInStudent.this, "Some Error occured, Please try Again After Some Time! ", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<Model> call, Throwable t) {
                ...
                Toast.makeText(SignInStudent.this,t.getMessage(),Toast.LENGTH_SHORT).show();
                Log.e("TAG", "error: " + t);
                progressDialog.cancel();
            }
        });
